...
const SERVICES: Service[] = [
  {
    title: 'Долгосрочное проектное кредитование',
    titleKz: 'Ұзақ мерзімді жобалық несиелеу',
    org: 'БРК',
    stage: null,
    cat: 'credit',
    dur: 'до 60 рабочих дней',
    result: 'Финансирование инвестиционного проекта обрабатывающей промышленности',
    desc: 'Средне- и долгосрочное кредитование крупных инвестиционных и инфраструктурных проектов обрабатывающей промышленности, включая «зелёную» энергетику',
    descKz: 'Өңдеуші өнеркәсіптің ірі инвестициялық және инфрақұрылымдық жобаларын, соның ішінде «жасыл» энергетиканы орта және ұзақ мерзімді несиелеу',
    conds: ['Резидент РК', 'Проект в обрабатывающей промышленности или инфраструктуре', 'Собственное участие не менее 20%', 'Окупаемость проекта'],
    condsKz: ['ҚР резиденті', 'Жоба өңдеуші өнеркәсіпте немесе инфрақұрылымда', 'Меншікті қатысу 20%-дан кем емес', 'Жобаның өзін-өзі ақтауы'],
    docs: ['Бизнес-план по стандартам БРК', 'Финансовые модели и отчётность за 3 года', 'Правоустанавливающие документы на залоги'],
    docsKz: ['ҚДБ стандарттары бойынша бизнес-жоспар', 'Қаржылық модельдер және 3 жылдық есептілік', 'Кепілдерге меншік құжаттары']
  },
  {
    ...
    desc: 'Предварительная заявка на финансовый лизинг авиатранспорта или железнодорожных вагонов через дочернюю структуру БРК — «БРК-Лизинг»',
    descKz: 'ҚДБ еншілес құрылымы «ҚДБ-Лизинг» арқылы авиакөлік немесе теміржол вагондарының қаржылық лизингіне алдын ала өтінім беру',
    conds: ['Резидент РК', 'Срок деятельности более 1 года', 'Отсутствие налоговой задолженности', 'Сумма от 80 млн ₸'],
    condsKz: ['ҚР резиденті', 'Қызмет мерзімі 1 жылдан астам', 'Салық берешегінің болмауы', 'Сомасы 80 млн ₸-ден бастап'],
  ...
  },
  {
    ...
    descKz: 'Шикізаттық емес тауар экспорттаушыларын шетелдік сатып алушының төлемеу тәуекелінен сақтандыру, аккредитивтер мен қарыздарды сақтандыру',
    conds: ['Резидент РК — экспортёр несырьевых товаров', 'Наличие экспортного контракта', 'Иностранный покупатель-нерезидент'],
    condsKz: ['ҚР резиденті — шикізаттық емес тауар экспорттаушысы', 'Экспорттық келісімшарттың болуы', 'Шетелдік сатып алушы-бейрезидент'],
    docs: ['Экспортный контракт', 'Сведения об иностранном покупателе', 'Финансовая отчётность за последний период'],
    docsKz: ['Экспорттық келісімшарт', 'Шетелдік сатып алушы туралы мәліметтер', 'Соңғы кезеңдегі қаржылық есептілік']
  },
  {
    title: 'Предэкспортное и торговое финансирование',
    titleKz: 'Экспорт алдындағы және сауда қаржыландыруы',
    org: 'ЭКА',
    stage: null,
    cat: 'credit',
    dur: 'до 30 рабочих дней',
    result: 'Финансирование и гарантирование экспортной операции',
    desc: 'Предэкспортное и экспортное торговое финансирование, гарантирование экспортных операций и субсидирование ставок по торговому финансированию',
    descKz: 'Экспорт алдындағы және экспорттық сауда қаржыландыруы, экспорттық операцияларды кепілдендіру және сауда қаржыландыруы мөлшерлемелерін субсидиялау',
    conds: ['Субъект несырьевого экспорта', 'Подписанный экспортный контракт', 'Отсутствие просроченной задолженности'],
    condsKz: ['Шикізаттық емес экспорт субъектісі', 'Қол қойылған экспорттық келісімшарт', 'Мерзімі өткен берешектің болмауы'],
    docs: ['Копия экспортного контракта', 'Финансовая отчётность за 2 года', 'Справка об отсутствии задолженности'],
    docsKz: ['Экспорттық келісімшарттың көшірмесі', '2 жылдық қаржылық есептілік', 'Берешектің жоқтығы туралы анықтама']
  },
  {
    title: 'Долевое (венчурное) финансирование',
    ...
    descKz: 'Шикізаттық емес секторларға (денсаулық сақтау, АӨК, «жасыл» энергетика, IT) «қорлар қоры» моделі бойынша үлестік инвестициялау — несиелеудің орнына капиталға 49%-ға дейін кіру',
    conds: ['Несырьевой сектор экономики', 'Действующий бизнес с потенциалом роста', 'Потенциал привлечения соинвесторов', 'Готовность к вхождению партнёра в капитал'],
    condsKz: ['Экономиканың шикізаттық емес секторы', 'Өсу әлеуеті бар қолданыстағы бизнес', 'Қоса инвесторларды тарту әлеуеті', 'Серіктестің капиталға кіруіне дайындық'],
    docs: ['Инвестиционный меморандум', 'Финансовые модели и прогнозы на 5 лет', 'Аудированная отчётность за 3 года', 'Структура акционерного капитала'],
    docsKz: ['Инвестициялық меморандум', '5 жылдық қаржылық модельдер мен болжамдар', '3 жылдық аудиторланған есептілік', 'Акционерлік капитал құрылымы']
  },
  {
    title: 'Гарантирование кредитов «Даму Оптима»',
    titleKz: '«Даму Оптима» несиелерін кепілдендіру',
    org: 'Даму',
    stage: null,
    cat: 'guarantee',
    dur: 'до 2 рабочих дней',
    result: 'Гарантия фонда с покрытием до 85% суммы кредита',
    desc: 'Рыночно-ориентированные частичные гарантии банкам при нехватке залога у МСБ. Покрытие до 85%, стоимость гарантии 1,5% (МСБ) / 2% (крупные проекты)',
    descKz: 'ШОБ-та кепіл жеткіліксіз болған жағдайда банктерге нарыққа бағдарланған ішінара кепілдіктер. 85%-ға дейін жабу, кепілдік құны 1,5% (ШОБ) / 2% (ірі жобалар)',
    conds: ['Субъект МСБ', 'Нехватка собственного залога', 'Положительное решение банка о выдаче кредита', 'Отсутствие просроченной задолженности'],
    condsKz: ['ШОБ субъектісі', 'Меншікті кепілдің жеткіліксіздігі', 'Банктің несие беру туралы оң шешімі', 'Мерзімі өткен берешектің болмауы'],
  ...
  {
    title: 'Субсидирование ставки «Іскер аймақ»',
    titleKz: '«Іскер аймақ» мөлшерлемесін субсидиялау',
    org: 'Даму',
    stage: null,
    cat: 'subsidy',
    dur: 'до 30 рабочих дней',
    result: 'Снижение ставки вознаграждения по кредиту МСБ в регионе',
    desc: 'Региональная программа субсидирования процентной ставки для МСБ в регионах (кроме Астаны и Алматы). Общий лимит поддержки — 1,2 трлн ₸ до 2028 года',
    descKz: 'Аймақтардағы (Астана мен Алматыдан басқа) ШОБ үшін пайыздық мөлшерлемені субсидиялаудың өңірлік бағдарламасы. Қолдаудың жалпы лимиті — 2028 жылға дейін 1,2 трлн ₸',
    conds: ['Субъект МСБ в регионе (кроме Астаны и Алматы)', 'Кредит оформлен в банке-партнёре', 'Деятельность в приоритетных секторах'],
    condsKz: ['Аймақтағы ШОБ субъектісі (Астана мен Алматыдан басқа)', 'Несие серіктес банкте рәсімделген', 'Басым секторлардағы қызмет'],
  ...
  {
    title: 'Жилищный заём по системе ЖСС',
    titleKz: 'ТҚЖ жүйесі бойынша тұрғын үй қарызы',
    org: 'Отбасы',
    stage: null,
    cat: 'credit',
    dur: 'до 20 рабочих дней',
    result: 'Жилищный заём по ставке от 3,5% до 7% годовых на срок до 20 лет',
    desc: 'Жилищные, промежуточные и предварительные займы в рамках системы жилищных строительных сбережений, включая программы «Отау», «Наурыз», «Бақытты отбасы»',
    descKz: 'Тұрғын үй құрылыс жинақтары жүйесі аясындағы тұрғын үй, аралық және алдын ала қарыздар, соның ішінде «Отау», «Наурыз», «Бақытты отбасы» бағдарламалары',
    conds: ['Вкладчик системы ЖСС', 'Накопленная оценочная сумма по договору', 'Платёжеспособность заявителя'],
    condsKz: ['ТҚЖ жүйесінің салымшысы', 'Шарт бойынша жинақталған бағалау сомасы', 'Өтініш берушінің төлем қабілеттілігі'],
    docs: ['Удостоверение личности', 'Договор о жилищных строительных сбережениях', 'Справка о доходах', 'Документы на приобретаемое жильё'],
    docsKz: ['Жеке куәлік', 'Тұрғын үй құрылыс жинақтары туралы шарт', 'Табыс туралы анықтама', 'Сатып алынатын тұрғын үйге құжаттар']
  },
  {
    title: 'Гарантирование долевого строительства',
    titleKz: 'Үлестік құрылысты кепілдендіру',
    org: 'КЖК',
    stage: null,
    cat: 'guarantee',
    dur: 'до 30 рабочих дней',
    result: 'Гарантия завершения строительства объекта долевого участия',
    desc: 'Гарантирование обязательств застройщиков, включая новую гарантию на реновацию жилья и гарантии для малоэтажного строительства',
    descKz: 'Құрылыс салушылардың міндеттемелерін кепілдендіру, соның ішінде тұрғын үйді жаңғыртуға жаңа кепілдік және аз қабатты құрылысқа кепілдіктер',
    conds: ['Застройщик с действующим разрешением', 'Соответствие требованиям закона о долевом строительстве', 'Финансовая устойчивость проекта'],
    condsKz: ['Қолданыстағы рұқсаты бар құрылыс салушы', 'Үлестік құрылыс туралы заң талаптарына сәйкестік', 'Жобаның қаржылық тұрақтылығы'],
    docs: ['Проектная документация', 'Разрешение на строительство', 'Финансовая модель проекта', 'Правоустанавливающие документы на землю'],
    docsKz: ['Жобалық құжаттама', 'Құрылысқа рұқсат', 'Жобаның қаржылық моделі', 'Жерге меншік құжаттары']
  },
  {
    title: 'Льготное кредитование АПК «Кең дала»',
    titleKz: '«Кең дала» АӨК жеңілдікті несиелеу',
    org: 'АКК',
    stage: null,
    cat: 'credit',
    dur: 'до 25 рабочих дней',
    result: 'Финансирование весенне-полевых и уборочных работ',
    desc: 'Раннее льготное финансирование весенне-полевых и уборочных работ, а также программы «Агробизнес», «Сыбаға» (закуп КРС) для сельхозтоваропроизводителей',
    descKz: 'Көктемгі-егіс және жиын-терім жұмыстарын ерте жеңілдікті қаржыландыру, сондай-ақ ауыл шаруашылығы тауар өндірушілеріне арналған «Агробизнес», «Сыбаға» (ІҚМ сатып алу) бағдарламалары',
    conds: ['Сельхозтоваропроизводитель', 'Наличие земельного или производственного актива', 'Опыт хозяйствования не менее 1 года'],
    condsKz: ['Ауыл шаруашылығы тауар өндірушісі', 'Жер немесе өндірістік активтің болуы', 'Шаруашылық жүргізу тәжірибесі 1 жылдан кем емес'],
    docs: ['Заявление-анкета на кредитование', 'Правоустанавливающие документы на землю/технику', 'Технико-экономическое обоснование', 'Финансовая отчётность за 1–2 года'],
    docsKz: ['Несиелеуге өтінім-сауалнама', 'Жерге/техникаға меншік құжаттары', 'Техника-экономикалық негіздеме', '1–2 жылдық қаржылық есептілік']
  },
  {
    title: 'Микрокредитование сельской молодёжи',
    titleKz: 'Ауыл жастарын микронесиелеу',
    org: 'АКК',
    stage: null,
    cat: 'credit',
    dur: 'до 15 рабочих дней',
    result: 'Микрокредит под 2,5% годовых для предпринимателей до 35 лет',
    desc: 'Микрокредиты под обеспечение по ставке 2,5% годовых для сельских предпринимателей в возрасте до 35 лет на развитие собственного дела',
    descKz: '35 жасқа дейінгі ауыл кәсіпкерлеріне өз ісін дамытуға қамтамасыз ету бойынша жылдық 2,5% мөлшерлемемен микронесиелер',
    conds: ['Возраст до 35 лет', 'Регистрация в сельской местности', 'Наличие обеспечения по микрокредиту', 'Бизнес-идея или действующее дело'],
    condsKz: ['35 жасқа дейінгі жас', 'Ауылдық жерде тіркелу', 'Микронесие бойынша қамтамасыз етудің болуы', 'Бизнес-идея немесе қолданыстағы іс'],
    docs: ['Удостоверение личности', 'Заявление-анкета', 'Бизнес-план / Описание проекта', 'Документы на залоговое обеспечение'],
    docsKz: ['Жеке куәлік', 'Өтінім-сауалнама', 'Бизнес-жоспар / Жоба сипаттамасы', 'Кепілдік қамтамасыз ету құжаттары']
  }
];
...
const ORGANIZATIONS = [
  {
    ...
    color: '#EAF3EE',
    text: '#135F3D',
    desc: 'Национальный институт развития, специализирующийся на средне- и долгосрочном финансировании крупных проектов обрабатывающей промышленности и инфраструктуры.',
    descKz: 'Өңдеуші өнеркәсіп пен инфрақұрылымның ірі жобаларын орта және ұзақ мерзімді қаржыландыруға маманданған ұлттық даму институты.',
    director: 'Елибаев Марат Талгатович',
    address: 'г. Астана, пр. Мангилик Ел, БЦ «Байтерек»',
    phone: '+7 (7172) 79-26-79',
    email: 'info@kdb.kz'
  },
  {
    abbr: 'ЭКА',
    name: 'Экспортно-кредитное агентство Казахстана',
    nameKz: 'Қазақстанның Экспорттық-кредиттік агенттігі',
    color: '#FBF8EF',
    text: '#A08636',
    desc: 'Единый оператор по продвижению несырьевого экспорта (бренд KazakhExport): страхование экспортёров от риска неплатежа, торговое финансирование и гарантирование экспортных операций.',
    descKz: 'Шикізаттық емес экспортты ілгерілету жөніндегі бірыңғай оператор (KazakhExport бренді): экспорттаушыларды төлемеу тәуекелінен сақтандыру, сауда қаржыландыруы және экспорттық операцияларды кепілдендіру.',
    director: 'Чайжунусов Аллен Сержанович',
    address: 'г. Астана, пр. Мангилик Ел, 55А, БЦ «Байтерек»',
    phone: '+7 (7172) 95-56-56',
    email: 'info@kazakhexport.kz'
  },
  {
    abbr: 'QIC',
    name: 'Qazaqstan Investment Corporation',
    nameKz: 'Qazaqstan Investment Corporation',
    color: '#EAF3EE',
    text: '#146843',
    desc: 'Институт долевого и венчурного финансирования, работающий по модели «фонда фондов»: привлечение инвесторов и вхождение в капитал несырьевых проектов (до 49%).',
    descKz: '«Қорлар қоры» моделі бойынша жұмыс істейтін үлестік және венчурлік қаржыландыру институты: инвесторларды тарту және шикізаттық емес жобалардың капиталына кіру (49%-ға дейін).',
    director: 'Каримсаков Дидар Нурлыбекович',
    address: 'г. Астана, пр. Мангилик Ел, БЦ «Байтерек»',
    phone: '+7 (7172) 55-42-22',
    email: 'info@qic.kz'
  },
  {
    abbr: 'Даму',
    ...
    color: '#FBF8EF',
    text: '#18794D',
    desc: 'Основной оператор поддержки МСБ: гарантирование кредитов («Даму Оптима»), субсидирование ставок и региональные программы для микро-, малого и среднего бизнеса.',
    descKz: 'ШОБ қолдаудың негізгі операторы: несиелерді кепілдендіру («Даму Оптима»), мөлшерлемелерді субсидиялау және шағын, орта бизнеске арналған өңірлік бағдарламалар.',
    director: 'Сарсекеев Фархат Кайнарович',
    address: 'г. Астана, единый контакт-центр 1408',
    phone: '1408',
    email: 'info@fund.kz'
  },
  {
    ...
    color: '#EAF3EE',
    text: '#0D4A2F',
    desc: 'Оператор системы жилищных строительных сбережений и ипотеки: жилищные займы по ставке 3,5–7% и программы «Отау», «Наурыз», «Бақытты отбасы».',
    descKz: 'Тұрғын үй құрылыс жинақтары және ипотека жүйесінің операторы: 3,5–7% мөлшерлемемен тұрғын үй қарыздары және «Отау», «Наурыз», «Бақытты отбасы» бағдарламалары.',
    director: 'Ибрагимова Ляззат Еркеновна',
    address: 'г. Алматы, ул. Розыбакиева, 97/6',
    phone: '+7 (727) 330-93-00',
    email: 'info@hcsbk.kz'
  },
  {
    abbr: 'КЖК',
    name: 'Казахстанская жилищная компания',
    nameKz: 'Қазақстандық тұрғын үй компаниясы',
    color: '#FBF8EF',
    text: '#135F3D',
    desc: 'Гарантирование долевого строительства и ипотечные программы: гарантии застройщикам (в т.ч. на реновацию жилья), «Орда Аймақ», система «Казреестр».',
    descKz: 'Үлестік құрылысты кепілдендіру және ипотекалық бағдарламалар: құрылыс салушыларға кепілдіктер (соның ішінде тұрғын үйді жаңғыртуға), «Орда Аймақ», «Қазтізілім» жүйесі.',
    director: 'Куздибаев Алтай',
    address: 'г. Астана, пр. Мангилик Ел, 55А',
    phone: '+7 (7172) 79-75-75',
    email: 'info@khc.kz'
  },
  {
    abbr: 'АКК',
    name: 'Аграрная кредитная корпорация',
    nameKz: 'Аграрлық несие корпорациясы',
    color: '#EAF3EE',
    text: '#146843',
    desc: 'Институт финансирования АПК (включает КазАгроФинанс): льготное кредитование и лизинг для аграриев — «Кең дала», «Сыбаға», микрокредитование сельской молодёжи.',
    descKz: 'АӨК қаржыландыру институты (ҚазАгроҚаржыны қамтиды): аграрийлерге жеңілдікті несиелеу және лизинг — «Кең дала», «Сыбаға», ауыл жастарын микронесиелеу.',
    director: 'Аширбеков Алмат Буркутбаевич',
    address: 'г. Астана, пр. Мангилик Ел, 8, сеть областных филиалов',
    phone: '+7 (7172) 55-99-00',
    email: 'uprkazn@agrocredit.kz'
  }
];
...
const getLocalApps = (): AppRecord[] => {
  try {
    const data = localStorage.getItem('baiterek_local_applications');
...
const saveLocalApp = (id: string, serviceId: number, user: User | null, formData: any) => {
  try {
    const current = getLocalApps();
    const newApp: AppRecord = {
      id,
      title: serviceId === 2 ? 'Лизинг авиатранспорта и вагонов — II Этап' : 'Лизинг авиатранспорта и вагонов — I Этап',
    ...
    localStorage.setItem('baiterek_local_applications', JSON.stringify([newApp, ...current]));
  } catch (e) {
    console.error('Error saving local app:', e);
  }
};
...
const App: React.FC = () => {
  ...
  const fetchAppsAndStats = useCallback(async () => {
    ...
    try {
      ...
      console.log('⚠️ Ошибка подключения к API при получении заявок:', e);
    }

    const localApps = getLocalApps();

    // Auto-Sync mechanism: if we have a valid connection, token, and local applications
    if (fetchSuccess && localApps.length > 0) {
      ...
      for (const localApp of localApps) {
        try {
          const syncRes = await fetch('http://localhost:3001/api/applications', {
            ...
            body: JSON.stringify({
              appNumber: localApp.id,
              serviceId: localApp.title.includes('II Этап') ? 2 : 1,
              userId: user?.id || 1,
              formData: localApp.formData
            })
          });
          if (syncRes.ok) {
            console.log(`✅ Локальная заявка ${localApp.id} успешно синхронизирована!`);
          }
        } catch (e) {
          console.warn(`⚠️ Ошибка синхронизации заявки ${localApp.id}:`, e);
        }
      }
      ...
      try {
        ...
        console.log('Error refreshing after sync:', e);
      }

      // Remove synced applications from localStorage
      const serverIds = new Set(serverApps.map(a => a.id));
      const remainingLocal = localApps.filter(a => !serverIds.has(a.id));
      localStorage.setItem('baiterek_local_applications', JSON.stringify(remainingLocal));
      
      setApps([...remainingLocal, ...serverApps]);
    } else if (fetchSuccess) {
      setApps(serverApps);
    } else {
      // Offline mode: show local applications
      setApps(localApps);
    }
    ...
    try {
      ...
      const totalCount = fetchSuccess ? serverApps.length : localApps.length;
      setStats({
        applications: totalCount,
        users: 1,
        services: 5,
        approved: (fetchSuccess ? serverApps : localApps).filter(a => a.status === 'approved').length,
        pending: (fetchSuccess ? serverApps : localApps).filter(a => a.status === 'submitted').length
      } as any);
    }
  }, [user]);
    ...
    <div>
          ...
          <div>
            ...
            <div className="hero-search-wrap">
              ...
              <div className="hero-chips">
                {(lang === 'ru'
                  ? ['Лизинг авиатранспорта', 'Кредиты МСБ', 'Гарантии Даму', 'Экспортное страхование']
                  : ['Авиакөлік лизингі', 'МСБ несиелері', 'Даму кепілдіктері', 'Экспорттық сақтандыру']
                ).map(chip => (
            ...
            <div className="hero-stats">
              ...
              <div><div className="hstat-num">7</div><div className="hstat-lbl">{lang === 'ru' ? 'Дочерних организаций' : 'Еншілес ұйым'}</div></div>
              ...
              <div><div className="hstat-num">₸3 трлн</div><div className="hstat-lbl">{lang === 'ru' ? 'Поддержка в 2026' : '2026 ж. қолдау'}</div></div>
            </div>
          </div>
      ...
      <footer className="site-footer">
        <div className="footer-grid">
          ...
          {[
            ...
            { title: lang === 'ru' ? 'Организации' : 'Ұйымдар', links: [
              ...
              { label: 'ЭКА (KazakhExport)', action: () => onSelectOrg(ORGANIZATIONS[1]) },
              { label: 'QIC', action: () => onSelectOrg(ORGANIZATIONS[2]) },
              { label: 'ФРП «Даму»', action: () => onSelectOrg(ORGANIZATIONS[3]) },
              { label: 'Отбасы банк', action: () => onSelectOrg(ORGANIZATIONS[4]) },
              { label: 'КЖК', action: () => onSelectOrg(ORGANIZATIONS[5]) },
        ...
        <div className="footer-bottom">
          <div>© 2026 АО «Национальный инвестиционный холдинг „Байтерек"». {lang === 'ru' ? 'Все права защищены.' : 'Барлық құқықтар қорғалған.'}</div>
...
const ORG_REPORTS: Record<string, { year: number; type: string; titleRu: string; titleKz: string }[]> = {
  ...
  'ЭКА': [
    { year: 2024, type: 'Годовой отчёт', titleRu: 'Годовой отчёт ЭКА (KazakhExport) за 2024 год', titleKz: 'ЭКА (KazakhExport) 2024 жылғы жылдық есебі' },
    { year: 2024, type: 'Финансовая отчётность', titleRu: 'Финансовая отчётность (МСФО) за 2024 г.', titleKz: '2024 жылғы қаржылық есептілік (ХҚЕС)' },
  ],
  'QIC': [
    { year: 2024, type: 'Годовой отчёт', titleRu: 'Годовой отчёт QIC за 2024 год', titleKz: 'QIC-тің 2024 жылғы жылдық есебі' },
    { year: 2024, type: 'Финансовая отчётность', titleRu: 'Финансовая отчётность (МСФО) за 2024 г.', titleKz: '2024 жылғы қаржылық есептілік (ХҚЕС)' },
  ],
  'Даму':  [
  ...
  'Отбасы': [
    { year: 2024, type: 'Годовой отчёт', titleRu: 'Годовой отчёт Отбасы банка за 2024 год', titleKz: 'Отбасы банктің 2024 жылғы жылдық есебі' },
    { year: 2024, type: 'Финансовая отчётность', titleRu: 'Финансовая отчётность (МСФО) за 2024 г.', titleKz: '2024 жылғы қаржылық есептілік (ХҚЕС)' },
  ],
  'КЖК': [
    { year: 2024, type: 'Годовой отчёт', titleRu: 'Годовой отчёт КЖК за 2024 год', titleKz: 'ҚТҮК-тің 2024 жылғы жылдық есебі' },
    { year: 2024, type: 'Финансовая отчётность', titleRu: 'Финансовая отчётность (МСФО) за 2024 г.', titleKz: '2024 жылғы қаржылық есептілік (ХҚЕС)' },
  ],
  'АКК': [
...
const ORG_PROCUREMENTS: Record<string, { num: string; title: string; titleKz: string; deadline: string; status: string; amount: string }[]> = {
  ...
  'ЭКА': [
    { num: 'ЭКА-2026-002', title: 'Услуги перестрахования экспортных рисков', titleKz: 'Экспорттық тәуекелдерді қайта сақтандыру қызметтері', deadline: '20.08.2026', status: 'active', amount: '40 000 000 ₸' },
  ],
  'QIC': [
    { num: 'QIC-2026-002', title: 'Консалтинговые услуги по инвестициям', titleKz: 'Инвестиция бойынша консалтингтік қызметтер', deadline: '30.07.2026', status: 'active', amount: '55 000 000 ₸' },
  ],
  'Даму': [
    { num: 'ДАМУ-2026-014', title: 'Аренда офисных помещений в регионах', titleKz: 'Аймақтарда кеңселік үй-жайларды жалға алу', deadline: '30.06.2026', status: 'active', amount: '36 000 000 ₸' },
    { num: 'ДАМУ-2026-015', title: 'Услуги PR и коммуникации', titleKz: 'PR және коммуникация қызметтері', deadline: '25.07.2026', status: 'active', amount: '18 500 000 ₸' },
  ],
  'Отбасы': [
    { num: 'ОТБ-2026-011', title: 'Сопровождение мобильного приложения банка', titleKz: 'Банктің мобильді қосымшасын сүйемелдеу', deadline: '12.08.2026', status: 'active', amount: '64 000 000 ₸' },
  ],
  'КЖК': [
    { num: 'КЖК-2026-005', title: 'Развитие информационной системы «Казреестр»', titleKz: '«Қазтізілім» ақпараттық жүйесін дамыту', deadline: '18.07.2026', status: 'active', amount: '72 000 000 ₸' },
  ],
  'АКК': [
    { num: 'АКК-2026-007', title: 'Закупка сельскохозяйственной техники', titleKz: 'Ауыл шаруашылық техникасын сатып алу', deadline: '10.07.2026', status: 'active', amount: '120 000 000 ₸' },
  ],
};
...
const OrgDetailsPage: React.FC<{
  ...
  return (
    <div style={{ paddingBottom: 60 }}>
      {/* Hero */}
      <div className="service-hero" style={{ background: `linear-gradient(135deg, ${org.text} 0%, #08301F 100%)` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
...
const ORG_COLORS: Record<string, string> = {
  'БРК': 'linear-gradient(135deg,#135F3D,#08301F)',
  'Банк Развития Казахстана': 'linear-gradient(135deg,#135F3D,#08301F)',
  'ЭКА': 'linear-gradient(135deg,#A08636,#5A4B1D)',
  'KazakhExport': 'linear-gradient(135deg,#A08636,#5A4B1D)',
  'QIC': 'linear-gradient(135deg,#146843,#08301F)',
  'Даму': 'linear-gradient(135deg,#18794D,#0D4A2F)',
  'Отбасы': 'linear-gradient(135deg,#0D4A2F,#08301F)',
  'КЖК': 'linear-gradient(135deg,#135F3D,#0D4A2F)',
  'АКК': 'linear-gradient(135deg,#146843,#08301F)',
  'Байтерек': 'linear-gradient(135deg,#146843,#08301F)',
  'default': 'linear-gradient(135deg,#135F3D,#08301F)',
};
...
const KnowledgePage: React.FC<{ 
  ...
  return (
    <div style={{ padding: '0 20px 40px' }}>
      <div className="service-hero" style={{ background: 'linear-gradient(135deg, #08301F 0%, #135F3D 100%)' }}>
    ...
    if (stepIdx < steps.length - 1) { 
      ...
      try {
        ...
        if (res.ok) {
          ...
          console.warn('⚠️ Ошибка сохранения на бэкенде, сохраняем локально:', res.status);
          saveLocalApp(id, svc.stage === 2 ? 2 : 1, user, computed);
        }
      } catch(e) {
        console.warn('⚠️ Работаем в локальном режиме без бэкенда, сохраняем в локальное хранилище:', e);
        saveLocalApp(id, svc.stage === 2 ? 2 : 1, user, computed);
      }
      setLoading(false);
      onSubmit(id);
      ...
      <div className="application-layout">
        ...
        <div className="app-form-area">
          ...
          {curStep.fields.some(f => f.type === 'file') && (
            <div style={{ background: 'var(--green-50)', border: '1px solid var(--green-100)', borderRadius: 10, padding: '10px 14px', marginBottom: 12, fontSize: 13, color: 'var(--green-700)', display: 'flex', gap: 10, alignItems: 'flex-start' }}>
              <span>ℹ️</span>
              <div>
...
const DashPage: React.FC<{ 
  ...
  // Status mapping
  const getStatusBadge = (a: AppRecord) => {
    if (a.isLocal) {
      return <span className="badge" style={{ background: '#f1f5f9', color: '#64748b', border: '1px dashed #cbd5e1' }}>☁ Ожидает синхронизации</span>;
    }
    switch (a.status) {
      ...
      default: return <span className="badge badge-gray">{a.status}</span>;
    }
  };
          ...
          {activeApp ? (
            ...
            <div className="detail-card" style={{ padding: 24 }}>
              ...
              <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 20 }}>
                <span>Статус: {getStatusBadge(activeApp)}</span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {total >= 80000000 && (
                <div style={{ padding: '10px 14px', background: 'var(--blue-light)', borderRadius: 8, borderLeft: '4px solid var(--blue)' }}>
                  ...
                  <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 2 }}>Лизинг авиатранспорта и вагонов — от 80 млн ₸</div>
                </div>
              )}
              {total >= 5000000 && (
              ...
              {total >= 5000000 && (
                <div style={{ padding: '10px 14px', background: '#fefce8', borderRadius: 8, borderLeft: '4px solid #eab308' }}>
                  <strong style={{ fontSize: 13 }}>АКК — Льготный кредит АПК</strong>
                  <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 2 }}>Для АПК — программы «Кең дала», «Сыбаға»</div>
                </div>
              )}
              {total >= 1000000000 && (
                <div style={{ padding: '10px 14px', background: 'var(--green-50)', borderRadius: 8, borderLeft: '4px solid var(--green-600)' }}>
                  <strong style={{ fontSize: 13 }}>QIC — Долевое финансирование</strong>
                  <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 2 }}>Вхождение в капитал проекта до 49%</div>
                </div>
              )}
              {total < 5000000 && (
...
const VacanciesPage: React.FC<{ redirectCount: number | null; onApply: (title: string) => void; lang?: string }> = ({ redirectCount, onApply, lang = 'ru' }) => {
  ...
  const list = [
    ...
    {
      title: 'Андеррайтер по страхованию экспортных рисков',
      titleKz: 'Экспорттық тәуекелдерді сақтандыру андеррайтері',
      org: 'ЭКА',
      salary: ru ? 'По договорённости' : 'Келісім бойынша',
      experience: ru ? 'более 5 лет' : '5 жылдан астам',
      type: ru ? 'Полная занятость' : 'Толық жұмыс уақыты',
      city: 'Астана',
      url: 'https://hh.kz/search/vacancy?text=%D1%8D%D0%BA%D1%81%D0%BF%D0%BE%D1%80%D1%82+%D1%81%D1%82%D1%80%D0%B0%D1%85%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5&area=160',
    },
    {
  ...
  const orgColors: Record<string, string> = {
    'БРК': '#135F3D', 'Банк Развития': '#135F3D',
    'ЭКА': '#A08636', 'Даму': '#18794D', 'Отбасы': '#0D4A2F',
    'КЖК': '#135F3D', 'АКК': '#146843', 'QIC': '#146843',
    'Байтерек': '#146843',
  };
  const getOrgColor = (org: string) =>
    Object.keys(orgColors).find(k => org.includes(k)) ? orgColors[Object.keys(orgColors).find(k => org.includes(k))!] : '#135F3D';

  return (
    <div style={{ paddingBottom: 60 }}>
      <div className="service-hero" style={{ background: 'linear-gradient(135deg, #08301F 0%, #146843 100%)' }}>
...
const AboutPage: React.FC<{
  ...
  const leadership = [
    { name: 'Бектенов Олжас Абаевич', role: ru ? 'Председатель Совета директоров (Премьер-Министр РК)' : 'Директорлар кеңесінің төрағасы (ҚР Премьер-Министрі)', since: ru ? 'с 2026 года' : '2026 жылдан' },
    { name: 'Карагойшин Рустам Тимурович', role: ru ? 'Председатель Правления Холдинга «Байтерек»' : '«Байтерек» холдингінің Басқарма Төрағасы', since: ru ? 'с февраля 2024 года' : '2024 жылдың ақпанынан' },
    { name: 'Айдапкелов Нурболат', role: ru ? 'Первый заместитель Председателя Правления' : 'Басқарма Төрағасының бірінші орынбасары', since: ru ? 'с 2025 года' : '2025 жылдан' },
    { name: 'Онжанов Тимур', role: ru ? 'Заместитель Председателя Правления' : 'Басқарма Төрағасының орынбасары', since: ru ? 'с 2025 года' : '2025 жылдан' },
  ];

  const docs = [
    { title: ru ? 'Стратегия развития Холдинга «Байтерек» на 2024–2033 гг.' : '«Байтерек» холдингінің 2024–2033 жж. даму стратегиясы', type: 'PDF', year: 2024 },
    { title: ru ? 'Годовой отчёт Холдинга за 2024 год' : 'Холдингтің 2024 жылғы жылдық есебі', type: 'PDF', year: 2024 },
    { title: ru ? 'Кодекс корпоративного управления' : 'Корпоративтік басқару кодексі', type: 'PDF', year: 2023 },
    { title: ru ? 'План мероприятий по устойчивому развитию (ESG) 2026–2028' : 'Тұрақты дамудың (ESG) 2026–2028 іс-шаралар жоспары', type: 'PDF', year: 2026 },
    { title: ru ? 'Дивидендная политика Холдинга' : 'Холдингтің дивидендтік саясаты', type: 'PDF', year: 2023 },
  ];

  const facts = [
    { val: '7', label: ru ? 'дочерних организаций' : 'еншілес ұйым' },
    { val: '70+', label: ru ? 'мер господдержки' : 'мемлекеттік қолдау шарасы' },
    { val: '₸9 трлн', label: ru ? 'господдержки за 2024 г.' : '2024 ж. мемлекеттік қолдау' },
    { val: '17 231', label: ru ? 'рабочих мест создано' : 'жұмыс орны құрылды' },
  ];
    ...
    <div style={{ paddingBottom: 60 }}>
      ...
      <div className="service-hero" style={{ background: 'linear-gradient(135deg, var(--bt-navy-900) 0%, var(--bt-navy-700) 100%)', marginBottom: 0 }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.78)', fontSize: '1.05rem', maxWidth: 680, lineHeight: 1.7, marginBottom: 32 }}>
          {ru
            ? 'Национальный инвестиционный холдинг — институт развития Республики Казахстан. Через 7 дочерних организаций объединяет инструменты поддержки бизнеса: финансирование, гарантирование, экспорт, жильё и агропромышленный комплекс. Единственный акционер — Правительство РК.'
            : 'Ұлттық инвестициялық холдинг — Қазақстан Республикасының даму институты. 7 еншілес ұйым арқылы бизнесті қолдау құралдарын біріктіреді: қаржыландыру, кепілдендіру, экспорт, тұрғын үй және агроөнеркәсіптік кешен. Жалғыз акционер — ҚР Үкіметі.'}
        </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
            <div className="bt-card" style={{ borderTop: '3px solid var(--bt-gold-500)' }}>
              ...
              <p style={{ color: 'var(--ink-700)', lineHeight: 1.75, margin: 0 }}>
                {ru
                  ? 'Содействие устойчивому росту экономики Казахстана через поддержку производства казахстанских товаров и услуг, модернизацию инфраструктуры и укрепление продовольственной безопасности на принципах ответственности перед обществом.'
                  : 'Қоғам алдындағы жауапкершілік қағидаттарында қазақстандық тауарлар мен қызметтер өндірісін қолдау, инфрақұрылымды жаңғырту және азық-түлік қауіпсіздігін нығайту арқылы Қазақстан экономикасының тұрақты өсуіне жәрдемдесу.'}
              </p>
            </div>
            <div className="bt-card" style={{ borderTop: '3px solid var(--bt-navy-700)' }}>
              ...
              <p style={{ color: 'var(--ink-700)', lineHeight: 1.75, margin: 0 }}>
                {ru
                  ? 'Стратегия развития на 2024–2033 гг.: поддержка крупного бизнеса и МСБ, повышение доступности жилья, рост несырьевого экспорта и финансовая поддержка агропромышленного комплекса.'
                  : '2024–2033 жж. даму стратегиясы: ірі бизнес пен ШОБ-ты қолдау, тұрғын үй қолжетімділігін арттыру, шикізаттық емес экспортты өсіру және агроөнеркәсіптік кешенді қаржылық қолдау.'}
              </p>
            </div>
          </div>
        </section>
...
const AdminPanel: React.FC<{
  ...
  useEffect(() => {
    ...
    onRefreshArticles();
    onRefreshLogs();
  }, [onRefreshApps, onRefreshNews, onRefreshArticles, onRefreshLogs]);
...
const AdminDashboard: React.FC<{ apps: AppRecord[]; stats: any; user: User | null; logs: any[] }> = ({ apps, stats, user, logs }) => {
  ...
  const statusData = [
    { label: 'На рассм.', value: apps.filter(a => a.status === 'submitted').length, color: 'var(--warn)' },
  ...
  const donutData = [
    { label: 'Одобрено', value: apps.filter(a => a.status === 'approved').length, color: '#16a34a' },
    { label: 'На рассмотрении', value: apps.filter(a => a.status === 'submitted').length, color: 'var(--warn)' },
    { label: 'Отклонено', value: apps.filter(a => a.status === 'rejected').length, color: '#ef4444' },
    ...
    <div>
      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <div className="stat-card-value" style={{ color: 'var(--warn)' }}>{stats.applications}</div>
      ...
      {selectedApp ? (
        <div className="detail-card" style={{ padding: 24 }}>
          ...
          <div>
            ...
            <pre style={{ background: '#0f172a', color: '#7CE0B0', padding: 14, borderRadius: 8, overflowX: 'auto', fontSize: 11, marginTop: 10 }}>
            ...
            <tbody>
              {apps.length ? apps.map(a => (
                <tr key={a.id}>
                  ...
                  <td>{a.userName}</td>
                  <td>
                    {a.isLocal && <span className="badge" style={{ background: '#f1f5f9', color: '#64748b', border: '1px dashed #cbd5e1' }}>☁ Ожидает синхронизации</span>}
                    {!a.isLocal && a.status === 'submitted' && <span className="badge badge-blue">На рассмотрении</span>}
                    {!a.isLocal && a.status === 'in_review' && <span className="badge badge-amber">В обработке</span>}
                    {!a.isLocal && a.status === 'additional_docs_required' && <span className="badge badge-red">Доп. документы</span>}
                    {!a.isLocal && a.status === 'approved' && <span className="badge badge-green">Одобрено</span>}
                    {!a.isLocal && a.status === 'rejected' && <span className="badge badge-red">Отклонено</span>}
                  </td>
                  <td>{a.date}</td>
                  <td>
...
Холдинг «Байтерек» включает 7 дочерних организаций: БРК (Банк Развития Казахстана), ЭКА/KazakhExport (Экспортно-кредитное агентство), QIC (Qazaqstan Investment Corporation), Фонд «Даму», Отбасы банк, КЖК (Казахстанская жилищная компания), АКК (Аграрная кредитная корпорация).

Доступные услуги на портале:
1. Долгосрочное проектное кредитование (БРК). Обрабатывающая промышленность и инфраструктура. Собственное участие от 20%. Срок до 60 рабочих дней.
2. Лизинг авиатранспорта и вагонов — I/II этап (БРК, через «БРК-Лизинг»). Сумма от 80 млн ₸.
3. Страхование экспортных контрактов (ЭКА/KazakhExport). Защита от неплатежа иностранного покупателя. Для экспортёров несырьевых товаров.
4. Предэкспортное и торговое финансирование (ЭКА/KazakhExport). Гарантирование экспортных операций и субсидирование ставок.
5. Долевое (венчурное) финансирование (QIC). Вхождение в капитал проекта до 49% вместо кредита. Несырьевые секторы.
6. Гарантирование кредитов «Даму Оптима» (Даму). Покрытие до 85% при нехватке залога. Решение до 2 рабочих дней. Для МСБ.
7. Субсидирование ставки «Іскер аймақ» (Даму). Для МСБ в регионах (кроме Астаны и Алматы).
8. Жилищный заём по системе ЖСС (Отбасы банк). Ставка 3,5–7%, до 20 лет. Программы «Отау», «Бақытты отбасы». Для населения.
9. Гарантирование долевого строительства (КЖК). Гарантии застройщикам, ипотека «Орда Аймақ». Для застройщиков и дольщиков.
10. Льготное кредитование АПК «Кең дала» (АКК). Финансирование посевных и уборочных работ, «Сыбаға». Для сельхозпроизводителей.
11. Микрокредитование сельской молодёжи (АКК). Ставка 2,5% для предпринимателей до 35 лет.
