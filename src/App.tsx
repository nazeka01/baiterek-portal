...
const DEFAULT_NEWS: any[] = [
  {
    Id: 'n7', Organization: 'Холдинг «Байтерек»', CreatedAt: '2026-07-09', ImageUrl: '',
    Title: 'Холдинг «Байтерек» усиливает независимость советов директоров',
    TitleKz: '«Байтерек» холдингі директорлар кеңестерінің тәуелсіздігін күшейтеді',
    Content: 'Холдинг «Байтерек» внедряет лучшие международные практики корпоративного управления, усиливая независимость советов директоров дочерних организаций. Это повышает прозрачность принятия решений и качество управления квазигосударственным сектором.',
    ContentKz: '«Байтерек» холдингі корпоративтік басқарудың үздік халықаралық тәжірибелерін енгізіп, еншілес ұйымдардың директорлар кеңестерінің тәуелсіздігін күшейтуде. Бұл шешім қабылдаудың ашықтығын және басқару сапасын арттырады.',
  },
  {
    Id: 'n8', Organization: 'Холдинг «Байтерек»', CreatedAt: '2026-07-08', ImageUrl: '',
    Title: 'Байтерек и SuperX AI Technology обсудили создание ИИ-инфраструктуры в Казахстане',
    TitleKz: 'Байтерек пен SuperX AI Technology Қазақстанда ЖИ-инфрақұрылымын құруды талқылады',
    Content: 'Холдинг «Байтерек» и компания SuperX AI Technology обсудили перспективы создания инфраструктуры искусственного интеллекта в Казахстане. Проект направлен на развитие цифровой экономики и технологического суверенитета страны.',
    ContentKz: '«Байтерек» холдингі мен SuperX AI Technology компаниясы Қазақстанда жасанды интеллект инфрақұрылымын құру перспективаларын талқылады. Жоба цифрлық экономика мен елдің технологиялық егемендігін дамытуға бағытталған.',
  },
  {
    Id: 'n9', Organization: 'АКК', CreatedAt: '2026-07-03', ImageUrl: '',
    Title: 'От удобрений до сельхозтехники: как «Байтерек» развивает АПК',
    TitleKz: 'Тыңайтқыштан ауылшаруашылық техникасына дейін: «Байтерек» АӨК-ні қалай дамытады',
    Content: 'Холдинг «Байтерек» поддерживает все сегменты агропромышленного комплекса — от производства удобрений до поставки сельхозтехники. Финансирование АПК идёт через Аграрную кредитную корпорацию по программам «Кең дала», «Сыбаға» и лизинг сельхозтехники.',
    ContentKz: '«Байтерек» холдингі агроөнеркәсіптік кешеннің барлық сегменттерін — тыңайтқыш өндірісінен ауылшаруашылық техникасын жеткізуге дейін қолдайды. АӨК қаржыландыруы Аграрлық несие корпорациясы арқылы «Кең дала», «Сыбаға» бағдарламалары және техника лизингі бойынша жүреді.',
  },
  {
    Id: 'n11', Organization: 'Холдинг «Байтерек»', CreatedAt: '2026-07-02', ImageUrl: '',
    Title: 'Байтерек и «Шинхан Банк Казахстан» обсудили расширение сотрудничества',
    TitleKz: 'Байтерек пен «Шинхан Банк Қазақстан» ынтымақтастықты кеңейтуді талқылады',
    Content: 'Холдинг «Байтерек» и АО «Шинхан Банк Казахстан» обсудили перспективы расширения взаимодействия в финансовой сфере, включая совместное финансирование проектов и привлечение инвестиций в экономику Казахстана.',
    ContentKz: '«Байтерек» холдингі мен «Шинхан Банк Қазақстан» АҚ қаржы саласындағы өзара іс-қимылды кеңейту перспективаларын, соның ішінде жобаларды бірлесіп қаржыландыру мен инвестиция тартуды талқылады.',
  },
  {
  ...
  {
    Id: 'n10', Organization: 'БРК', CreatedAt: '2026-05-18', ImageUrl: '',
    Title: 'БРК передаёт банкам второго уровня проекты на $4,5 млрд',
    TitleKz: 'ҚДБ екінші деңгейлі банктерге $4,5 млрд жобаларды береді',
    Content: 'Холдинг «Байтерек» передаёт коммерческим банкам ссудный портфель проектов Банка развития Казахстана на 4,5 млрд долларов. Уже передано 650 млн долларов, ещё около 1 млрд планируется в 2026 году, по семи проектам на 3,5 млрд долларов ведутся переговоры. Речь идёт о валютных займах экспортных предприятий, завершивших инвестиционную фазу.',
    ContentKz: '«Байтерек» холдингі Қазақстанның Даму Банкінің жобалар портфелін коммерциялық банктерге 4,5 млрд долларға береді. 650 млн доллар берілді, 2026 жылы тағы шамамен 1 млрд жоспарланған, 3,5 млрд доллардағы жеті жоба бойынша келіссөздер жүруде.',
  },
  {
